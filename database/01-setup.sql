...
CREATE TABLE `users` (
  ...
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'users email address',
  `password` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'user password',
  `reg_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'time and date registration'
